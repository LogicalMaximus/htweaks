...
public class FloodSquadSpawnerUtils {
    ...
    public static AbstractScavEntity createPatrolLeader(Patrol patrol, BlockPos pos, Level level, @Nullable AbstractScavEntity commander, @Nullable Entity vehicle) {
        ...
        if(chance > 0.5) {
            patrolLeader = ModEntities.FLOOD_ELITE.get().create(level);
        }
        else {
            patrolLeader = ModEntities.FLOOD_BRUTE.get().create(level);
        }
    ...
    public static void createPatrolMember(Patrol patrol, AbstractScavEntity leader, BlockPos pos, @Nullable Entity vehicle) {
        ...
        if (chance > 0.75) {
            FloodEliteEntity patrolMember = ModEntities.FLOOD_ELITE.get().create(leader.level());
            ...
            FloodBruteEntity patrolMember = ModEntities.FLOOD_BRUTE.get().create(leader.level());
            ...
            FloodJackalEntity patrolMember = ModEntities.FLOOD_JACKAL.get().create(leader.level());
            ...
            FloodMarineEntity patrolMember = ModEntities.FLOOD_MARINE.get().create(leader.level());
            ...
            FloodGruntEntity patrolMember = ModEntities.FLOOD_GRUNT.get().create(leader.level());
    ...
    public static void setInventory(AbstractScavEntity entity, String lootTableName) {
        ...
        if(entity instanceof FloodMarineEntity) {
