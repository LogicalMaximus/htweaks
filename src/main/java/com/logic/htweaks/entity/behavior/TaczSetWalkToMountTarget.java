...
public class TaczSetWalkToMountTarget<E extends AbstractScavEntity> extends ExtendedBehaviour<E> {
    ...
    public TaczSetWalkToMountTarget() {
    }
    ...
    public TaczSetWalkToMountTarget<E> speedMod(float speedModifier) {
        return this.speedMod((owner, target) -> {
            return speedModifier;
        });
    }

    public TaczSetWalkToMountTarget<E> speedMod(BiFunction<E, BlockPos, Float> speedModifier) {
        this.speedMod = speedModifier;
        return this;
    }

    public TaczSetWalkToMountTarget<E> closeEnoughDist(BiFunction<E, BlockPos, Integer> closeEnoughMod) {
    ...
    protected void start(E entity) {
        ...
        BlockPos targetPos = BrainUtils.getMemory(brain, ModMemoryTypes.MOUNT_TARGET.get()).blockPosition();
