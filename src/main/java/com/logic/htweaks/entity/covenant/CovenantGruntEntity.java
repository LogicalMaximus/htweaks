...
import com.logic.htweaks.entity.IPanic;
...
public class CovenantGruntEntity extends BaseCovenantTrooperEntity implements IPanic {

    public static final String LOOT_TABLE = "grunt";

    public CovenantGruntEntity(EntityType<? extends PathfinderMob> mob, Level level) {
        super(mob, level);
    }
